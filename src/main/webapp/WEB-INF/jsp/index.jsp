...
<body class="">
                ...
                <div class="text-white">
                    <div class="flex p-2 justify-center bg-gray-800">
                        <div class="flex py-3 px-2 items-center">
                            <p class="text-2xl text-green-500 font-semibold">SowSales</p>
                        </div>
                    </div>
                    <div class="flex justify-center">
                        <div class="justify-center">
                            <img class="hidden h-24 w-24 rounded-full sm:block object-cover mr-2"
                                src="https://i.ibb.co/0tgwZyK/sow4-removebg-preview.png" alt="">
                        </div>
                    </div>
                    <div>
                        <ul class="mt-6 leading-10">
                            <li class="relative px-2 py-1 ">
                                <a class="inline-flex items-center w-full text-sm font-semibold text-white transition-colors duration-150 cursor-pointer hover:text-green-500" 
                                    ...
                                    <span class="ml-4">MONITORAMENTO</span>
                                </a>
                            </li>
                            <li class="relative px-2 py-1" x-data="{ Open : false  }">
                                <div class="inline-flex items-center justify-between w-full text-base font-semibold transition-colors duration-150 text-gray-500  hover:text-yellow-400 cursor-pointer"
                                    ...
                                    <span
                                        ...
                                        <span class="ml-4">CADASTROS</span>
                                    </span>
                                        ...
                                        <li class="px-2 py-1 text-white transition-colors duration-150">
                                            <div class="px-1 hover:text-gray-800 hover:bg-gray-100 rounded-md">
                                                <div class="flex items-center">
                                                    ...
                                                    <a href="/"
                                                        class="w-full ml-2  text-sm font-semibold text-white hover:text-gray-800">Produtos</a>
                                        ...
                                        <li class="px-2 py-1 text-white transition-colors duration-150">
                                            <div class="px-1 hover:text-gray-800 hover:bg-gray-100 rounded-md">
                                                <div class="flex items-center">
                                                    ...
                                                    <a href="/"
                                                        class="w-full ml-2  text-sm font-semibold text-white hover:text-gray-800">Pedidos</a>
                                        ...
                                        <li class="px-2 py-1 text-white transition-colors duration-150">
                                            <div class="px-1 hover:text-gray-800 hover:bg-gray-100 rounded-md">
                                                <div class="flex items-center">
                                                    ...
                                                    <a href="/"
                                                        class="w-full ml-2  text-sm font-semibold text-white hover:text-gray-800">Clientes</a>
                                        ...
                                        <div class="p-5">
                                            ...
                                            <div class="ml-2 w-full flex-1">
                                                <div>
                                                    ...
                                                    <div class="mt-1 text-base text-gray-600">Produtos</div>
                                                </div>
                                            </div>
                                        </div>
                                    </a>
                                        ...
                                        <div class="p-5">
                                            ...
                                            <div class="ml-2 w-full flex-1">
                                                <div>
                                                    ...
                                                    <div class="mt-1 text-base text-gray-600">Clientes</div>
                                                </div>
                                            </div>
                                        </div>
                                    </a>
                                        ...
                                        <div class="p-5">
                                            ...
                                            <div class="ml-2 w-full flex-1">
                                                <div>
                                                    ...
                                                    <div class="mt-1 text-base text-gray-600">Usuários</div>
                                                </div>
                                            </div>
                                        </div>
                                    </a>
    ...
    <script>
        ...
        var options = {
            series: [{
                ...
                type: 'line',
                data: [13, 23, 20, 8, 13, 27, 33, 12, 20, 8, 13]
            }],
            chart: {
                height: 350,
                type: 'line',
    ...
    <script>
        ...
        var options = {
            ...
            labels: ['Granels', 'Sementes', 'Sementes Tratadas'],
        };
        var chart = new ApexCharts(chart, options);
        chart.render();
    </script>
